...
def main():
    ...
    graph_1 = graph_list()
    graph_2 = graph_matrix()

    for v in vertices:
        graph_1.insert_vertex(vertex(v))
        graph_2.insert_vertex(vertex(v))
    for e1, e2 in edges:
        graph_1.insert_edge(vertex(e1), vertex(e2))
        graph_2.insert_edge(vertex(e1), vertex(e2))

    graph_1.delete_vertex('K')
    graph_1.delete_edge('E', 'W')
    graph_1.delete_edge('W', 'E')

    graph_2.delete_vertex('K')
    graph_2.delete_edge('E', 'W')
    graph_2.delete_edge('W', 'E')

    polska.draw_map(graph_1)
    polska.draw_map(graph_2)
